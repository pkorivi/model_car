...
for (size_t i = 0; i < final_states.size(); i++) {
  double cost_val = create_traj_const_acc_xy_spline_3(current_vehicle_state,m_prev_vehicle_state,mp_traj1, final_states[i],current_pos_map,curr_frenet_coordi);
