...
obst_odom_pub = rospy.Publisher("/obst_odom_1",Odometry, queue_size = 5)
sequence =0
var_abs_vel = 0
...
def pub_obstacle_info():
    ...
    obs_xy = [[7.3,-0.19]] #,[3.35,2.3],[3.69,2.4]
    for id_ in range(len(obs_xy)):
        ...
        #Obstacle odometry
        odom_quat = tf.transformations.quaternion_from_euler(0,0,1.2)
        odom = Odometry()
