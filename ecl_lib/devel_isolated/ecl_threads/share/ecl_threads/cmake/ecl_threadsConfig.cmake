...
if("TRUE" STREQUAL "TRUE")
  set(ecl_threads_SOURCE_PREFIX /home/korivi/model_car/ecl_lib/src/ecl_threads)
  set(ecl_threads_DEVEL_PREFIX /home/korivi/model_car/ecl_lib/devel_isolated/ecl_threads)
  ...
  set(ecl_threads_INSTALL_PREFIX /home/korivi/model_car/ecl_lib/install_isolated)
...
if(NOT "/home/korivi/model_car/ecl_lib/src/ecl_threads/include " STREQUAL " ")
  set(ecl_threads_INCLUDE_DIRS "")
  set(_include_dirs "/home/korivi/model_car/ecl_lib/src/ecl_threads/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ecl_threads' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/korivi/model_car/ecl_lib/src/ecl_threads/${idir}'.  Ask the maintainer 'Daniel Stonier <d.stonier@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/korivi/model_car/ecl_lib/devel_isolated/ecl_threads/lib;/home/korivi/model_car/ecl_lib/install_isolated/lib;/home/korivi/model_car/catkin_ws_user/devel/lib;/home/korivi/seat/catkin_ws/devel/lib;/home/korivi/seat/model_car_3/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
